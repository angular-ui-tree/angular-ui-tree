...
##### data-collapsed
Show a node collapsed or expanded according to its value.
Example: all the nodes generated by the following template will be collapsed.
```html
<ol ui-tree-nodes ng-model="nodes">
    <li class="wkfsfrc-button-bar"
         data-collapsed="true"
         ng-repeat="node in nodes"
         data-drag-delay="1000"
         ui-tree-node
